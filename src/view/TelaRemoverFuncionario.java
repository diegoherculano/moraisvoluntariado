...
import static dados.Dados.listaFuncionarios;
/**
 *
...
public class TelaRemoverFuncionario extends javax.swing.JFrame {
    ...
    public TelaRemoverFuncionario() {
        ...
        for (int i = 0; i < listaFuncionarios.size(); i++) {
            jComboBox1.addItem(listaFuncionarios.get(i).getNome());
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRemoverFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
